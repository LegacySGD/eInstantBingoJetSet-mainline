...
public class BingoJetSetCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BingoJetSetCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BingoInternationalIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BingoInternationalIW/InitOutcome.xml").getDocumentElement();
